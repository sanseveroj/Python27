...
def account_balancev2(client_id, api_key, api_secret):
    return (
        calls.APIAccountBalanceCallV2(client_id, api_key, api_secret)
        .call()
    )
...
def litecoin_withdrawal(client_id, api_key, api_secret, amount, address):
    return (
        calls.APILitecoinWithdrawalCall(client_id, api_key, api_secret)
        .call(amount=amount, address=address)
    )
...
def LTCUSD():
    return calls.APITickerCallLTCUSD().call()

def ETHUSD():
    return calls.APITickerCallETHUSD().call()
...
def balance_request(client_id, api_key, api_secret):
    return (
        calls.V2AccountBalance(client_id,api_key, api_secret).call()
    )
