...
class APIAccountBalanceCallV2(APIPrivateCall):
    url = '/v2/balance/'
...
class APILitecoinWithdrawalCall(APIPrivateCall):
    url = 'v2/ltc_withdrawal/'
...
class APITickerCallLTCUSD(APICall):
    url = '/v2/ticker/ltcusd'

    def _process_response(self, response):
        response['last'] = Decimal(response['last'])

class APITickerCallETHUSD(APICall):
    url = '/v2/ticker/ethusd'
...
class V2AccountBalance(APIPrivateCall):
    url = 'v2/balance/'
